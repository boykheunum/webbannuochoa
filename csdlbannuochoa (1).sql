...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 27, 2021 lúc 04:41 AM
...
CREATE TABLE `chitiethoadon` (
  ...
  `idmagiamgia` varchar(50) DEFAULT NULL
...
INSERT INTO `chitiethoadon` (`mahd`, `masp`, `soluongmua`, `giaban`, `thanhtien`, `idmagiamgia`) VALUES
(24, 'MSP002', 2, 850000, 1700000, '0'),
(26, 'MSP002', 1, 850000, 850000, '0'),
(26, 'MSP003', 1, 850000, 850000, '0'),
(27, 'MSP002', 1, 850000, 850000, '0'),
(27, 'MSP003', 1, 850000, 850000, '0'),
(28, 'MSP002', 1, 850000, 850000, '0'),
(28, 'MSP003', 1, 850000, 850000, '0'),
(29, 'MSP003', 1, 850000, 850000, 'G10K');
...
INSERT INTO `hoadon` (`mahd`, `ngayban`, `tongtien`, `makh`) VALUES
(24, '2021-06-26', 1700000, 2),
(26, '2021-06-26', 1700000, 2),
(27, '2021-06-26', 1700000, 2),
(28, '2021-06-26', 1700000, 2),
(29, '2021-06-26', 840000, 2);
...
('0', 0, '2000-12-28', '3000-12-29', 1000000000, 0, 0),
('G10K', 0, '2021-06-08', '2022-03-09', 1, 10000, 85000),
('PT10', 1, '2021-06-08', '2022-02-22', 9, 10, 85000);
...
('ND001', '123', 'Nguyễn Tiến Đạt', '0865228065', '95 hàng mã', 2);
...
INSERT INTO `nhanvien` (`macv`, `tennv`, `sdt`, `diachi`, `ngaysinh`, `manv`, `tendangnhap`, `matkhau`) VALUES
('1', 'Nguyễn Tiến Đạt', '0865228067', '95 Hàng Mã', '2000-12-28', 1, 'admin001', '123456'),
('2', 'Lò Hoàng Linh', '0865228777', '22 Hoàng Quốc Việt', '2000-12-06', 2, 'admin2', '123');
...
--
ALTER TABLE `hoadon`
  MODIFY `mahd` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
